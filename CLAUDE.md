...
`96e99b3f-9c53-486a-a8aa-8645058b3621`) — WHOOP-style nap handling: HealthKit sleep clustered into
sessions (longest = main sleep, other daytime sessions = naps), naps shown separately + credited
toward sleep need (~70%, capped 1.5h), and a "Log a nap" button that writes to Apple Health.**

**Shipped earlier: build 1.0.0 (20) uploaded to TestFlight 2026-09-15 (delivery UUID
...
**Shipped earlier: build 1.0.0 (18) uploaded to TestFlight 2026-09-15 (delivery UUID
...
**Shipped earlier: build 1.0.0 (16) uploaded to TestFlight 2026-09-15 (delivery UUID
